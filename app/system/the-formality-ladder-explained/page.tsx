...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "A 7-level system for placing any garment in social context, plus the ±1 rule that determines whether an outfit holds together. Practical and specific.",
  path: "/system/the-formality-ladder-explained",
  type: "article",
});
    ...
    <article className="space-y-10">
      ...
      <div className="max-w-2xl space-y-6 text-neutral-700">
        ...
        <p>
          ...
          <Link className="underline" href="/method">the method we use</Link> to
          build wardrobes that scale. The full system is 7 levels, one rule, and a
          few worked outfits.
        </p>
...
1  Athletic          ←  technical fabric, performance shoes`}
      ...
      <div className="max-w-2xl space-y-6 text-neutral-700">
        ...
        <p>
          ...
          <Link className="underline" href="/outfits/simple-outfit-formulas">
            outfit examples
          </Link>{" "}
